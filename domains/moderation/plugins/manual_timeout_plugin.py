...
class ManualTimeoutPlugin(BasePlugin):
    """POST /moderation/timeout — Request a platform-scoped timeout."""
    ...
    async def execute(self, data: dict, context=None):
        try:
            ...
            return {"success": True, "data": {"platform": platform, "user_id": user_id, "display_name": display_name, "duration_s": req.duration_s}}
